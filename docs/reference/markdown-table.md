...
generates the following output:
    ...
    * list item 4
    ...
    |------|-------------|------|---------|:--------:|
    | <a name="input_bool-1"></a> [bool-1](#input\_bool-1) | n/a | `bool` | `true` | no |
    ...
    | <a name="input_input_with_underscores"></a> [input\_with\_underscores](#input\_input\_with\_underscores) | n/a | `any` | n/a | yes |
    | <a name="input_list-1"></a> [list-1](#input\_list-1) | n/a | `list` | <pre>[<br>  "a",<br>  "b",<br>  "c"<br>]</pre> | no |
    ...
    | <a name="input_map-1"></a> [map-1](#input\_map-1) | n/a | `map` | <pre>{<br>  "a": 1,<br>  "b": 2,<br>  "c": 3<br>}</pre> | no |
    ...
    | <a name="input_number-1"></a> [number-1](#input\_number-1) | n/a | `number` | `42` | no |
    ...
    | <a name="input_string-1"></a> [string-1](#input\_string-1) | n/a | `string` | `"bar"` | no |
    ...
    | <a name="output_output-1"></a> [output-1](#output\_output-1) | n/a |
